...
namespace ITAsset4.Common
{
    ...
    public class SystemInfo
    {
        ...
        public string bios_serial { get; set; }       // 原始 BIOS 序列号
        public string machine_guid { get; set; }     // Windows MachineGuid
        public string hostname { get; set; } = "";
        public string ip { get; set; }
        public string os { get; set; }
        public string cpu { get; set; }
        public int? memory_gb { get; set; }
        public List<DiskInfo> disk_info { get; set; }
    ...
    public class TaskResult
    {
        ...
        public string install_log { get; set; }
    }
